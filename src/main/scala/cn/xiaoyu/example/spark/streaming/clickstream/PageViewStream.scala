...
package cn.xiaoyu.example.spark.streaming.clickstream

import cn.xiaoyu.example.spark.streaming.StreamingExamples
 ...
 * `$ bin/run-example cn.xiaoyu.example.spark.streaming.clickstream.PageViewGenerator 44444 10`
 * To process the generated stream
 * `$ bin/run-example \
 *    cn.xiaoyu.example.spark.streaming.clickstream.PageViewStream errorRatePerZipCode localhost 44444`
 */
// scalastyle:on
